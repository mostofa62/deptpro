...
const FinancialFreedomCalculator: React.FC = () => {
  ...
  function calculateMonthlyNeeded(
    ...
    const futureValueOfCurrentSavings =
      currentSavings * Math.pow(1 + monthlyReturnRate, monthsToTarget);
    ...
    const monthlyNeeded =
      ...
      (Math.pow(1 + monthlyReturnRate, monthsToTarget) - 1);
  ...
  const calculate = useCallback(() => {
    ...
    const freedomDate = new Date(
      currentDateP.setFullYear(currentDateP.getFullYear() + yearsToTarget)
    );
    // Calculate freedom age
    const freedomAge = currentAge + yearsToTarget;

    const monthlySavingsNeeded = calculateMonthlyNeeded(
      target,
      currentSavings,
      returnRateP,
      inflationP,
    ...
    const additionalSavings = Math.max(
      0,
      monthlySavingsNeeded - monthlyContribution
    );
    ...
    const chartDataArray = calculateChartData(
      currentSavings,
      monthlyContribution,
      returnRateP,
      inflationP,
  ...
  return (
    <div className="p-6 mx-auto rounded-md shadow-md border">
      ...
      <p className="flex items-center justify-center gap-2">
        <span>
          Calculate the estimated time you will reach your Financial Freedom
          Goal
        </span>
        <TooltipOne
          text={
            <div className="flex flex-col gap-1 items-start justify-center">
              <p className="whitespace-normal leading-normal">
                Disclosure: Financial Freedom Calculator
              </p>
              <p className="whitespace-normal leading-normal">
                For general information purposes only. Report any errors.
              </p>
              <p className="whitespace-normal leading-normal">
                This is an estimate of monthly amount needed to reach financial
                target before taxes and inflation.
              </p>
              <p className="whitespace-normal leading-normal">
                Adjust the calculator if you want to reach your target after
                taxes and inflation.
              </p>
              <p className="whitespace-normal leading-normal">
                Taxes and inflation are an estimate and will vary with US
                economy and world market changes.
              </p>
              <p className="whitespace-normal leading-normal">
                Savings is being reflected as accruing each month, presuming no
                loss and may not represent real world values.
              </p>
              <p className="whitespace-normal leading-normal">
                You are responsible for your own financial and tracking results
                through your various financial efforts.
              </p>
            </div>
          }
        />
          ...
          <div className="w-[50%]">
            <div className="flex flex-col gap-2">
              ...
              <input
                ...
                onChange={(e: any) =>
                  handleInputChange("currentDate", e.target.value)
                }
      ...
      <div className="flex gap-1 mt-6">
        <div
          className="w-[33%] py-3 rounded-lg text-white flex flex-col items-center justify-center"
        ...
        <div
          className="w-[33%] py-3 rounded-lg text-white px-1 flex flex-col items-center justify-center"
      ...
      <div className="flex my-6">
        <ResponsiveContainer width="100%" height={400}>
          <LineChart data={chartData}>
            ...
            <Line
              type="monotone"
              dataKey="totalContributingBalance"
              stroke="rgba(255, 159, 0, 1)"
              name="Total Contributing Balance"
            />
            <Line
              type="monotone"
              dataKey="totalAccumulation"
              stroke="rgba(66, 172, 216, 1)"
              name="Total Accumulation"
            />
            <Line
              type="monotone"
              dataKey="afterTaxInflationBalance"
              stroke="rgba(49, 196, 162, 1)"
              name="After Tax & Inflation Balance"
            />
          </LineChart>
        </ResponsiveContainer>
      </div>
      ...
      <div className="flex gap-1 mt-6">
        <div
          className="w-[50%] py-3 rounded-lg text-white flex flex-col items-center justify-center"
          style={{ background: "linear-gradient(135deg, #31c4a2, #27a589)" }}
        >
        ...
        <div
          className="w-[50%] py-3 rounded-lg text-white px-1 flex flex-col items-center justify-center"
          style={{ background: "linear-gradient(135deg, #31c4a2, #27a589)" }}
        >
