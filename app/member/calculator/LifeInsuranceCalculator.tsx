...
const LifeInsuranceCalculator: React.FC<LifeInsuranceCalculatorProps> = () => {
  ...
  return (
    <div className="p-6 bg-gray-100 rounded-md shadow-md border  mx-auto">
      ...
      <p className='text-center'>Financial security begins by planning for the predictable & unpredictable.</p>
      <p className='flex items-center justify-center gap-2'>
        <span>Use this tool to estimate the needs of you and your loved ones.</span>
        <TooltipOne text={<div className='flex flex-col gap-1 items-start justify-center'>
            <p className="whitespace-normal leading-normal">Disclosure: This is a simple educational tool to assist your life insurance needs.</p>
            <p className="whitespace-normal leading-normal">Your life insurance options will vary by state, carrier, health &amp; lifestyle underwriting.</p>
            <p className="whitespace-normal leading-normal">This is for educational purposes only to be used as a general guide.</p>
            <p className="whitespace-normal leading-normal">We are not tax advisors or legal consultant attorneys.</p>
            <p className="whitespace-normal leading-normal">Please consult a life &amp; financial advisor for your life insurance options.</p>
            <p className="whitespace-normal leading-normal">Consult a tax advisor, CPA for tax concerns.</p>
            <p className="whitespace-normal leading-normal">Consult an estate planning attorney for trusts etc.</p>
      ...
      >
        ...
        <button
          type="submit"
          className="w-full py-2 px-4 bg-[#2ecc71] text-white font-semibold rounded-lg shadow-md hover:bg-[#27ae60] focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75"
        >
          Calculate
        </button>
      </form>
      ...
      <table className="table-auto border-collapse border border-gray-300 w-full mt-4">        
        <tbody>
          {Object.entries(results).map(([key, value]) => (
            <tr key={key}>
              <td className={` border-b border-gray-300 px-4 py-2 capitalize ${key == 'recommendedCoverage'? 'bg-[#42acd8] font-semibold text-white':'bg-[#f8f9fa] text-black'}`}>
