...
export default function InsuranceCreate() {
  ...
  const SavingCatData: SavingSrcProps[] = SavingCategoryData.saving_category;

  useEffect(() => {
    setSavingSource(SavingCatData);
  }, [SavingCatData]);
            ...
            onClick: async () => {
              ...
              DeleteActionGlobal({
                ...
                if (deletedData.deleted_done > 0) {
                  const filterSource: SavingSrcProps[] = savingSource.filter(
                    (dt: SavingSrcProps) => dt.value !== id
                  );
            ...
            <div className="flex flex-col">
              ...
              <div className="mt-1">
                <p className="text-[17px] text-[#4f4f4f]">
                  Begin saving and unleash your financial power. Even small
                  contributions can add quickly!
                </p>
              </div>
            </div>
                  ...
                  <div className="flex flex-col md:flex-row md:mt-[15px]">
                    ...
                    <div className="w-full md:ml-[24px] md:w-[32%]">
                      <FormikSelectCreatableInput
                        ...
                        deleteSelectedOption={(data: SavingSrcProps) =>
                          deleteAction(data)
                        }
                      />
                    </div>
                    ...
                    <div className="w-full md:ml-[24px] md:w-[32%]">
                      <FormikFieldInput
                        ...
                        errorMessage={
                          ...
                          touched.fetchdata &&
                          touched.fetchdata.starting_date &&
                          errors.fetchdata.starting_date
                        }
                      />
                    </div>
                    ...
                    <div className="w-full md:ml-[24px] md:w-[32%]">
                      <FormikFieldInput
                        ...
                        errorMessage={
                          ...
                          touched.fetchdata &&
                          touched.fetchdata.starting_amount &&
                          errors.fetchdata.starting_amount
                        }
                        inputPreix={`$`}
                        toolTipText={
                          <p className="flex flex-col whitespace-normal leading-normal">
                            <span>
                              You may be jump starting your savings account
                            </span>
                            <span>or</span>
                    ...
                    <div className="w-full md:w-[32%]">
                      <FormikFieldInput
                        ...
                        errorMessage={
                          ...
                          touched.fetchdata &&
                          touched.fetchdata.contribution &&
                          errors.fetchdata.contribution
                        }
                        inputPreix={`$`}
                        toolTipText={
                          <div className="flex flex-col items-start justify-center gap-0">
                            <p className="whitespace-normal leading-normal">
                              This is an amount you choose to regularly fund
                              your savings.
                            </p>
                            <p className="whitespace-normal leading-normal">
                              The Savings Boost are for one time contributions.
                            </p>
                            <p className="whitespace-normal leading-normal">
                              You can add multiple one time contributions here.
                            </p>
                            <p className="whitespace-normal leading-normal">
                              IE: Putting your tips into savingsseveral times a
                              month.
                            </p>
                            <p className="whitespace-normal leading-normal">
                              A little adds up quickly!{" "}
                            </p>
                          </div>
                        }
                      />
                    ...
                    <div className="w-full md:ml-[24px] md:w-[32%]">
                      <FormikFieldInput
                        ...
                        errorMessage={
                          ...
                          touched.fetchdata &&
                          touched.fetchdata.increase_contribution_by &&
                          errors.fetchdata.increase_contribution_by
                        }
                        inputPreix={`$`}
                        toolTipText={
                          <p className="flex flex-col items-center justify-center gap-0">
                            <span className="whitespace-normal leading-normal">
                              ie: Add an increasing $1 each week.
                            </span>
                            <span className="whitespace-normal leading-normal">
                              ie: week 1 = $1. Week 4 would be $4.{" "}
                            </span>
                            <span className="whitespace-normal leading-normal">
                              Incremental savings can add up quickly.{" "}
                            </span>
                          </p>
                        }
                      />
