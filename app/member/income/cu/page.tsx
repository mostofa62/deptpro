...
export default function IncomeCreate() {
  ...
  const IncomeSourceData: IncomeSrcProps[] =
    IncomeSourceBoostData.income_source;
            ...
            onClick: async () => {
              ...
              DeleteActionGlobal({
                ...
                if (deletedData.deleted_done > 0) {
                  const filterSource: IncomeSrcProps[] = incomeSource.filter(
                    (dt: IncomeSrcProps) => dt.value !== id
                  );
                      ...
                      <div className="flex flex-col md:flex-row md:mt-[15px] gap-2">
                        ...
                        <div className="md:ml-[24px] md:w-[32%]">
                          <FormikSelectCreatableInput
                            ...
                            toolTipText={
                              <p className="flex flex-col whitespace-normal leading-tight">
                                <span>
                                  ie: Job, 2nd job, side gig, rental, pension,
                                  social security, annuity, investments
                                </span>
                              </p>
                            }
                            deleteSelectedOption={(data: IncomeSrcProps) =>
                              deleteAction(data)
                            }
                          />
                        </div>
                        ...
                        <div className="md:ml-[24px] md:w-[32%]">
                          <FormikFieldInput
                            ...
                            errorMessage={
                              ...
                              touched.fetchdata &&
                              touched.fetchdata.gross_income &&
                              errors.fetchdata.gross_income
                            }
                            inputPreix={`$`}
                          />
